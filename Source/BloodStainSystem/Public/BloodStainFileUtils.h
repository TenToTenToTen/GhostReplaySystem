...
struct FBloodStainFileUtils
{
	 ...
	 * @return 성공 여부
	 */
	static bool SaveToFile(const FRecordSavedData& SaveData, const FString& FileName, const FBloodStainFileOptions& Options = FBloodStainFileOptions());
	/**
	 ...
	 * @return 성공 여부
	 */
	static bool LoadFromFile(FRecordSavedData& OutData, const FString& FileName);
	 ...
	 */
	static int32 LoadAllFiles(TMap<FString, FRecordSavedData>& OutLoadedDataMap);
